    ...
    <form action="/register.php" method="post" class="bg-slate-100 rounded-md px-8 py-6 shadow border border-slate-300 max-w-md w-full flex flex-col space-y-3">
        <div class="flex flex-col">
            ...
            @if (array_key_exists('name', $errors))
                <span class="text-sm text-red-500 pt-1">{{ $errors['name'] }}</span>
            @endif
        </div>
        <div class="flex flex-col">
            ...
            @if (array_key_exists('email', $errors))
                <span class="text-sm text-red-500 pt-1">{{ $errors['email'] }}</span>
            @endif
        </div>
        <div class="flex flex-col">
            ...
            @if (array_key_exists('password', $errors))
                <span class="text-sm text-red-500 pt-1">{{ $errors['password'] }}</span>
            @endif
        </div>
        <div class="flex pt-3">
